...
// Champions Regulation M-C") cross-checked against master c23d2e94 — the
// same SHA the vendored champions tables (src/vendor/champions) are pinned
// to. Notable exclusions confirmed there: Farfetch'd-Galar and Mr. Mime-Galar
...
// ability corrections in `../mega-species-patch.ts`.
